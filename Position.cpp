...
void Position::Display() {
    ...
    v[fFood.y][fFood.x] = 'o';
    if(fSnake.x >= 0 && fSnake.x < fWidth && fSnake.y >= 0 && fSnake.y < fHeigth) {
		char c;
		switch(fDirection) {
			case RIGHT:	c = '>'; break;
			case LEFT:	c = '<'; break;
...
std::vector<Direction> Position::GetPossibleDirections() {
